...
```
There are totally `r nrow(unique_baseline_participants)` participants only appear in baseline dataset : participants with id `r only_baseline_id`.
There are totally `r nrow(unique_amyloid_participants)/5` participants only appear in amyloid dataset : participants with id `r only_amyloid_id`. 
